                ...
                <div class="container px-5 py-14 mx-auto flex flex-col">
                    ...
                    <div class="flex flex-col sm:flex-row mt-10">
                        ...
                        <div class="sm:w-2/3 sm:pl-2 sm:py-0 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                            <p class="leading-relaxed text-lg mb-4">name</p>
                            <p class="leading-relaxed text-lg mb-4">Email</p>
                            <p class="leading-relaxed text-lg mb-4">phone number</p>
                            <p class="leading-relaxed text-lg mb-4">city</p>
