...
const AdminHelp = () => {
    return (
        <div className='px-12'>
            ...
            <section class="flex flex-col max-w-full mx-auto overflow-hidden bg-white rounded-lg shadow-lg md:flex-row md:h-48">

                {/* text-section */}
                <div class="md:flex md:items-center md:justify-center md:w-1/2 md:bg-primary">
